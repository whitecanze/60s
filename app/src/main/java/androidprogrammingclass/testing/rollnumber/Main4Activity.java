...
public class Main4Activity extends AppCompatActivity {
    ...
    String getNum, getTime, getHex, chkNum,cr,wr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        num = rd.nextInt(255);
        getHex = Integer.toHexString(num);
        txtroll.setText(getHex);
        convertNum = Integer.parseInt(getHex, 16);
